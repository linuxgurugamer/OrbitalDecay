...
namespace WhitecatIndustries
{
    ...
    internal class UserInterface : MonoBehaviour
    {
        ...
        private void GuiOn() { ToolbarInterface.GuiOff(); }
        ...
        {
            GUILayout.BeginHorizontal();
            GUILayout.Label("Vessel Information", centeredBigLabel, GUILayout.Width(INFO_WIDTH));
            GUILayout.EndHorizontal();
        ...
        public void SettingsTab()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("Control Panel", centeredBigLabel, GUILayout.Width(INFO_WIDTH));
            GUILayout.EndHorizontal();
